...
console.log ("Die Einwohnerzahl in"+germany+"ist in den letzten 2 Jahren um" + ProzentD+"% gesteigen");
...
console.log ("Die Einwohnerzahl in" +france+"ist in den letzten 2 Jahren"+ ProzentFR+ "5 gestiegen");
...
console.log ("Die Einwohnerzahl in"+spain+"ist in den letzten zwei Jahren um"+ProzentSP+"5 gestiegen")